...
> **Post-P03 record (2026-09-21):** `UVP_P01=PASS`, `UVP_P02=PASS`, and
> `UVP_P03=PASS`; progress is `3/39` (`3/27` in the engine gate), and
> `UVP_P04` is next. The order and plan hash below are unchanged. See
